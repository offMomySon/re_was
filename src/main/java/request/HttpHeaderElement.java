...
public class HttpHeaderElement {
    ...
    private static final int KEY_VALUE_DELIMITERED_SIZE = 2;
    ...
    public static HttpHeaderElement from(String line) {
        ...
        String[] splitLine = line.split(KEY_VALUE_DELIMITER, KEY_VALUE_DELIMITERED_SIZE);
    ...
    private static String[] createValueElement(String value) {
        ...
        for (String valueElement : valueElements) {
            if (StringUtils.containsWhitespace(valueElement) || valueElement.isEmpty()) {
